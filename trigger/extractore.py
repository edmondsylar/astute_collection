...
file_path = '/root/Astute/privacy/Server/dumps.csv'
file_path2 = '/root/Astute/privacy/Server/dumps.sql'
host = 'localhost'
user = 'root'
password = None
mysql_to_csv(sql, file_path, host, user, password)
os.system('mysqldump -u root development_sdn > {}'.format(file_path2))
